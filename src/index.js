	...
	view: function(vnode) {
		return m("div", { class: "flex flex-row text-surface"}, [
            m("div", { class: "shrink-0 py-8 px-6 pb-4 w-80 space-y-2 text-sm"}, [
                ...
                m("div", { class: "flex flex-row items-center space-x-2.5 rounded-md p-2 font-medium text-surfacevariant"}, 
            ...
            m("div", { class: "py-8 w-full flex justify-center" }, [
                m("div", { class: "w-full max-w-7xl"},  [
                    ...
                    m("div", { class: "flex flex-row items-center space-x-8 text-sm"}, [
                        m("div", [
                            m("div", { class: "h-24 w-40 mb-4 rounded-lg bg-white"} ),
                            m("div", "Light")
                        ]),
                        m("div", [
                            m("div", { class: "h-24 w-40 mb-4 rounded-lg bg-gray-800"} ),
                            m("div", "Dark")
                        ]),
                        m("div", [
                            m("div", { class: "h-24 w-40 mb-4 rounded-lg bg-lime-500"} ),
                            m("div", "Lime")
                        ]),
                        m("div", [
                            m("div", { class: "h-24 w-40 mb-4 rounded-lg bg-rose-400"} ),
                            m("div", "Rosé")
                        ])
                    ])
                ])
